...
saver_directory_rgb = config["train_saver_directory_rgb"]
saver_directory_composite = config["train_saver_directory_composite"]
saver_directory_fusion = config["train_saver_directory_fusion"]
